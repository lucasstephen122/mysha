...
<div class="row green">
	<div class="col-md-12">
		<h3 class="m-v-0"><?php echo $user['name']; ?> &nbsp;</h3>
	...
	<div class="col-md-12">
		...
		<form id="frm_application" name="frm_application" action="<?php echo $base_url ?>admin/application_update/<?php echo $user['user_id']; ?>" method="POST">
					...
					<div class="action">
						...
						<div class="row">
							<div class="col col-xs-3">
								<button type="submit" id="btn_submit" class="btn btn-block btn-primary">Update</button>
							</div>
							<div class="col col-xs-3">
								<a href="<?php echo $base_url ?>admin/application_approve/<?php echo $user['user_id']; ?>" class="btn btn-block btn-pink">Approve</a>
							</div>
							<div class="col col-xs-3">
								<a href="<?php echo $base_url ?>admin/application_reject/<?php echo $user['user_id']; ?>" class="btn btn-block btn-default">Reject</a>
							</div>
							<div class="col col-xs-3">
								<a href="<?php echo $base_url ?>admin/applications" class="btn btn-block btn-default">Back</a>
							</div>
						</div>	
